 ...
 * 我的消息
 */
public class FyjpMsgAdapter extends BaseAdapter{
	...
	public FyjpMsgAdapter(Context context, List<FyjpPhotoDto> mArrayList) {
		mContext = context;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ViewHolder mHolder;
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.fyjp_adapter_msg, null);
