 ...
 * 我的上传-已上传
 */
public class FyjpUploadedAdapter extends BaseAdapter implements StickyGridHeadersSimpleAdapter {
	...
	public FyjpUploadedAdapter(Context context, List<FyjpPhotoDto> mArrayList) {
