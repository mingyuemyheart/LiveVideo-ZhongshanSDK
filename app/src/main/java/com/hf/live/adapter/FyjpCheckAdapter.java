...
public class FyjpCheckAdapter extends BaseAdapter{
	...
	public FyjpCheckAdapter(Context context, List<FyjpPhotoDto> mArrayList) {
		mContext = context;
	...
	public int getItemViewType(int position) {
		// current menu type
		FyjpPhotoDto data = mArrayList.get(position);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		final FyjpPhotoDto dto = mArrayList.get(position);
