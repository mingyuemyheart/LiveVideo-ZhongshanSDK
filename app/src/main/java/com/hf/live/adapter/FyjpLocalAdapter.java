...
public class FyjpLocalAdapter extends BaseAdapter implements StickyGridHeadersSimpleAdapter{
	...
	public FyjpLocalAdapter(Context context, List<FyjpPhotoDto> mArrayList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (TextUtils.equals(dto.workstype, "imgs")) {
			...
			if (!TextUtils.isEmpty(dto.videoUrl)) {
				File file = FyjpCommonUtil.getLocalThumbnail(dto.workTime);
	...
	private class AsynLoadTask extends AsyncTask<Void, Bitmap, Bitmap> {
		...
		protected Bitmap doInBackground(Void... params) {
			return FyjpCommonUtil.getVideoThumbnail(imgUrl, width, height, kind);
		}
