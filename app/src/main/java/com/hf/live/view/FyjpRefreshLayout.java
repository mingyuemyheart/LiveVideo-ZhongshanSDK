 ...
 */
public class FyjpRefreshLayout extends ViewGroup {
    private static final String LOG_TAG = FyjpRefreshLayout.class.getSimpleName();
...
//            }
     ...
     * @param context
     */
    public FyjpRefreshLayout(Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public FyjpRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
