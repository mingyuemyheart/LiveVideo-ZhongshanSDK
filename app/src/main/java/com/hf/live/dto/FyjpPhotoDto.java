...
public class FyjpPhotoDto implements Parcelable {
	...
	protected FyjpPhotoDto(Parcel in) {
	...
	public static final Creator<FyjpPhotoDto> CREATOR = new Creator<FyjpPhotoDto>() {
		@Override
		public FyjpPhotoDto createFromParcel(Parcel source) {
			return new FyjpPhotoDto(source);
		}

		@Override
		public FyjpPhotoDto[] newArray(int size) {
			return new FyjpPhotoDto[size];
		}
	};
}
