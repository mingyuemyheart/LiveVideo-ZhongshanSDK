...
public class FyjpUploadDto implements Parcelable{
	...
	protected FyjpUploadDto(Parcel in) {
	...
	public static final Creator<FyjpUploadDto> CREATOR = new Creator<FyjpUploadDto>() {
		@Override
		public FyjpUploadDto createFromParcel(Parcel source) {
			return new FyjpUploadDto(source);
		}

		@Override
		public FyjpUploadDto[] newArray(int size) {
			return new FyjpUploadDto[size];
		}
	};
}
